...
/*
OLD SETTINGS
$upload_dir = '/skp/data/images/'; // path from base_url to base of upload folder (with start and final /)
$root = rtrim($_SERVER['DOCUMENT_ROOT'],'/'); // don't touch this parameter
$base_url='http://'.$_SERVER['SERVER_NAME'];  // base url of site (without final /). If you prefer relative urls leave empty
$current_path = '../../../../data/images/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '..'.$upload_dir; // relative path from filemanager folder to thumbs folder (with final /)
*/


//Q3 modified getting values from session -->
/*
if (defined('SID')) {
    session_start();
}

//Globalne zmienne (na serwerze)
$base_url = rtrim($_SESSION["absurl"],'/'); 
$upload_dir = "/".$_SESSION["upl_dir"]; 
...
//pobrać całą nazwę serwera i usunąc tylko hosta
