					...
					<head>
						...
						<style type='text/css'>
							...
							*{margin:0;padding:0;}
							...
							#body{background:none;margin:0 auto;padding:30px 12px 0;width:776px;}
							...
							.clear{clear:both;}
							#footer{margin:0 auto 0;border-top:10px solid#FF531A;width:800px;}
